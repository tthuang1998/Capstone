...
AzureRealTime: Run our pipeline with real-time image processing using the Azure Kinect
'''
...
class AzureKinect:
    ...
    '''
    Function: Runs camera input, processes images & constructs pointcloud
    '''
    def run(self):
